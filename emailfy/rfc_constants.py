"""
This module provides constants and functions for validating email addresses based on RFC specifications.

Constants:
- ATEXT: Regular expression pattern for valid ASCII characters in email addresses.
